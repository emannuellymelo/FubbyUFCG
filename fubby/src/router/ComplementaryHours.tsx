...
const ComplementaryHours = () => {
    ...
    return (
        <Box>
            ...
            <VStack h={'65vh'} textAlign={'center'} pt={'7rem'} spacing={'2rem'} fontFamily={'Poppins'}>
                <HStack>
                    <Clock size={32} />
            ...
            <Flex id={'informacoes'} direction={'column'} fontFamily={'Poppins'} justifyContent={'left'}>
                ...
                <Text pl={'5%'} fontSize={'xl'} fontWeight={'400'} pb={7}>Nessa sessão, vou responder algumas das dúvidas mais frequentes entre os alunos, você pode encontrar um conteúdo com mais completude no documento oficial correspondente à <Link color={'blue.500'} href={'https://www.computacao.ufcg.edu.br/graduacao/procedimentos-graduação/aproveitamento-de-atividades-complementares'}>Regulamentação de Atividades Complementares.</Link></Text>
                <List spacing={3} pl={'7rem'} fontSize={'xl'} pr={'5%'} textAlign={'justify'}>
                    <ListItem>
                        <ListIcon as={Clock} color={'blue.400'} />
